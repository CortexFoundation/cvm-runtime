...
class QDQQuantizer(YAMRTQuantizer):
    def __init__(self, model, per_channel, reduce_range, mode, static, weight_qType, input_qType, tensors_range,
        ...
        YAMRTQuantizer.__init__(self, model, per_channel, reduce_range, mode, static, weight_qType, input_qType,
    ...
    def quantize_model(self):
        ...
        if not self.add_qdq_pair_to_weight:
            YAMRTQuantizer.CleanGraphInitializers(self.model.graph(), self.model.model)
