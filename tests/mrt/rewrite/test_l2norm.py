...
def test_l2normalization_rewrite_tile():
    verify_l2normalization_rewrite_tile((16, 512, 64, 64), 0, "channel")
    verify_l2normalization_rewrite_tile((1, 512, 64, 64), 1e-5, "channel")
    verify_l2normalization_rewrite_tile((16, 512, 64, 64), 1e-5, "channel")
    verify_l2normalization_rewrite_tile((16, 512, 64, 64), 1, "channel")

    verify_l2normalization_rewrite_tile((16, 512, 64, 64), 0, "instance")
    verify_l2normalization_rewrite_tile((1, 512, 64, 64), 1e-5, "instance")
    verify_l2normalization_rewrite_tile((16, 512, 64, 64), 1e-5, "instance")
    verify_l2normalization_rewrite_tile((16, 512, 64, 64), 1, "instance")

    verify_l2normalization_rewrite_tile((16, 512, 64, 64), 0, "spatial")
    verify_l2normalization_rewrite_tile((1, 512, 64, 64), 1e-5, "spatial")
    verify_l2normalization_rewrite_tile((16, 512, 64, 64), 1e-5, "spatial")
    verify_l2normalization_rewrite_tile((16, 512, 64, 64), 1, "spatial")

if __name__ == '__main__':
    # test_l2normalization_rewrite()
    test_l2normalization_rewrite_tile()
