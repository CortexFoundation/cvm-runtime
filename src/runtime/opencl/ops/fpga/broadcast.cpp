...
int broadcast_i_index(const int *oshape, int o_index, const int *ishape, int idim, int odim)
{
  int index = 0;
  int allIndex = 1;
...
extern "C"
{
  void broadcast(
      ...
      const int adim, const int bdim, const int cdim,
      const int ashape0, const int ashape1, const int ashape2, const int ashape3, int ashape4, int ashape5,
      const int bshape0, const int bshape1, const int bshape2, const int bshape3, int bshape4, int bshape5,
      const int cshape0, const int cshape1, const int cshape2, const int cshape3, int cshape4, int cshape5,
      const int type)
  {
